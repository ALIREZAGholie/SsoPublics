...
{
    public class RankEditCommand : ICommand<bool>
    {
    ...
    public class RankEditValidator : AbstractValidator<RankEditCommand>
    {
        public RankEditValidator()
        {
            RuleFor(x => x.Id)
    ...
    public class RankEditHandler : ICommandHandler<RankEditCommand, bool>
    {
        private readonly IRankRepository _repository;
        private readonly IUnitOfWork _unitOfWork;

        public RankEditHandler(IRankRepository repository, IUnitOfWork unitOfWork)
        {
            _repository = repository;
            _unitOfWork = unitOfWork;
        }

        public async Task<OperationResult<bool>> Handle(RankEditCommand request, CancellationToken cancellationToken)
        {
            try
            {
